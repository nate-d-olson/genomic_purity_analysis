...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}
\includegraphics[width=\maxwidth]{figure/contam_resid-1} \caption[Error rate [(estimated - true)/true] for pairwise combinations of material and contaminant]{Error rate [(estimated - true)/true] for pairwise combinations of material and contaminant. Point and error bars represent the median and range (minimum - maximum) error rate for each material and contaminant combination, and error bars indicate range of observed error.}\label{fig:contam_resid}
\end{figure}
