...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}
\includegraphics[width=\maxwidth]{figure/genus_tree} \caption[Taxonomic lineage of genera used in baseline assessment]{Taxonomic lineage of genera used in baseline assessment.}\label{fig:single_org_tree}
\end{figure}
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}
\includegraphics[width=\maxwidth]{figure/contam_ani-1} \caption[Genomic similarity, percent of genome aligned and average nucleotide identity, between pairs of representative strains used in contaminant detection assessment]{Genomic similarity, percent of genome aligned and average nucleotide identity, between pairs of representative strains used in contaminant detection assessment.}\label{fig:contam_ani}
\end{figure}
