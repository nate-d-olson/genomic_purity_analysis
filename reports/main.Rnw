...
high sensitivity methods not requiring \textit{a priori} assumptions about the contaminant. 
...
datasets from ten organisms as individuals and binary mixtures at varying ratiosparticularly as related to contaminant concentration and taxonomy.
...
Using the proposed method to characterize microbial material purity will help to ensure that the materials used to validate pathogen detection assays, generate genome assemblies for database submission, 
