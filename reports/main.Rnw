...
%% TODO %%
%\textbf{Better description for how use of Docker and github promotes repeatability.}
%% TODO %%
...
%% Need results for plasmids and vectors - plasmids could be grouped with phage
...
%% This could be due to contaminant being present in single genome data 
