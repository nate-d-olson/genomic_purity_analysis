...
\begin{abstract}
https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=1&cad=rja&uact=8&ved=0ahUKEwiX_66yrPHOAhVGwiYKHbmIBVsQFggeMAA&url=http%3A%2F%2Fwww.nature.com%2Fnature%2Fauthors%2Fgta%2FLetter_bold_para.doc&usg=AFQjCNEMG5dPqNAr5HKRtrwS85VUaX1IkA&sig2=8YfKJRO9TPfH5eEEUqyqtQ
- basic introduction
...
* How would this method be applied to different applications
  * Culture collections
    * how the results from the study support (or not) the use of the method for each application
