...
Sequence data was simulated for \Sexpr{sum(single_tbl_df$N)} strains, from 10 genera (Table \ref{tab:single_org}, Supplemental Table 1).
...
<<contam_ani, echo = FALSE, message = FALSE, fig.cap = "Genomic similarity, percent of genome aligned and average nucleotide identity, between pairs of representative strains used in contaminant detection assessment.", fig.lp="fig:">>=
contam_pairs %>% 
      ggplot() + 
