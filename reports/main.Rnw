...
For the individual genomes the false positive contaminants reported depended on the genus with \textit{Staphylococcus}, \textit{Escherichia}, and \textit{Shigella} having the highest proportion of false positives. 
For nearly all binary mixtures the contaminant was detected in the \textit{in-silico} datasets at the equivalent of 1 in 1,000 cells. Though \textit{F. tularensis} was not detected in any of the simulated contaminant mixtures and \textit{Y. pestis} was only detected at the equivlent of 1 in 10 cells. 
